...
public class ParallaxForMovingObjects : MonoBehaviour
{
    ...
    void LateUpdate()
    {
       //float temp = (cameraTransform.position.x * (1 - parallaxEffectMultiplier.x)) ;
        ...
        //(try to use number instead of deltamovement - worked!)
        transform.position += new Vector3(parallaxEffectMultiplier.x, parallaxEffectMultiplier.y);
